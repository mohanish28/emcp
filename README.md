...
| `SalesforceAdapter` | Salesforce MCP | ❌ | ✅ | opportunities, contacts, accounts, cases, leads — SOQL results |
| `LinearAdapter` | Linear MCP | ❌ | ✅ | issues, projects, teams, cycles — priority 1–4, identifier in name |
