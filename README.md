...
[![CI](https://github.com/YOUR_USERNAME/emcp/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/emcp/actions)
[![npm version](https://img.shields.io/npm/v/emcp)](https://www.npmjs.com/package/emcp)
...
// e.g. Figma frame "Dashboard" ↔ Notion page "Dashboard" ↔ Slack channel #dashboard
...
|---------|--------|---------|---------|-------|
| `FigmaAdapter` | Figma MCP | ✅ pixel-accurate | ✅ | x, y, w, h, fill, font, z-index |
| `NotionAdapter` | Notion MCP | ❌ | ✅ | pages, databases, blocks, properties |
...
```typescript
import type { EMCPAdapter, EnrichedNode } from 'emcp'
import { EMCP_SCHEMA_VERSION } from 'emcp'
...
|--------|------|---------|-------------|
| `adapters` | `EMCPAdapter[]` | `[]` | Additional adapters (Figma + Notion built-in) |
...
- [ ] MCP server registry (browse + install adapters)
- [ ] Visual debug UI
...
```bash
git clone https://github.com/YOUR_USERNAME/emcp.git
cd emcp
npm install
npm test
```
